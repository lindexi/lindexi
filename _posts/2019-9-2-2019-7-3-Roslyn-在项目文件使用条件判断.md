---
title: "2019-7-3-Roslyn-在项目文件使用条件判断"
author: lindexi
...
CreateTime: 2018-8-3 20:2:38 +0800
...
从 VisualStudio 安装文件夹打开开发人员工具命令行，打开这个是因为如果没有将 `msbuild` 加入到环境变量，就需要使用这个方法来调用 `msbuild` 调用 msbuild �---
title: "Roslyn 在项目文件使用条件判断"
author: lindexi
date: 2019-7-3 17:7:32 +0800
CreateTime: 2018-8-3 20:2:38 +0800
