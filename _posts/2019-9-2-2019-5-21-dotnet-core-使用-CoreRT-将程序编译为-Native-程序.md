---
title: "2019-5-21-dotnet-core-使用-CoreRT-将程序编译为-Native-程序"
author: lindexi
date: 2019-9-2 12:9:26 +0800
CreateTime: 2019-9-2 12:9:26 +0800
categories: C# dotnet dotnetcore C# dotnet dotnetcore
---
...
使用这个项目是比较难的，本文下面提供的包的版本，请大家按照我的安装的版本使用，因为新的版本可能有一些修改，同时没有更新文档，如果是第一次使用，可能会�---
title: "dotnet core 使用 CoreRT 将程序编译为 Native 程序"
author: lindexi
date: 2019-5-21 11:30:17 +0800
CreateTime: 2019-2-1 11:48:26 +0800
