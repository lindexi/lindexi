---
title: "2018-10-19-C#-序列类为-xml-可以使用的特性大全"
author: lindexi
...
实际就是做[将 .NET Core 项目打一个最简单的 NuGet 源码包，安装此包就像直接把源码放进项目一样 - walterlv](https://walterlv.github.io/post/the-simplest-way-to-pack---
title: "C# 序列类为 xml 可以使用的特性大全"
author: lindexi
date: 2018-10-19 9:9:47 +0800
CreateTime: 2018-6-23 9:36:2 +0800
