---
title: "2019-3-25-win10-uwp-如何将像素数组转-png-文件"
author: lindexi
...
author: lindexi
date: 2019-3-25 8:53:1 +0800
CreateTime: 2019-3-25 8:53:1 +0800
categories: Win10 UWP
...
```csharp
        ...
        private async Task ByteToPng(byte[] byteList, int width, int height, IRandomAccessStream file)
        {
            try
            {
                var encoder = await BitmapEncoder.CreateAsync(BitmapEncoder.PngE---
title: "win10 uwp 如何将像素数组转 png 文件"
author: lindexi
date: 2019-3-25 8:53:1 +0800
CreateTime: 2019-3-25 8:53:1 +0800
