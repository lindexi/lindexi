---
title: "2019-5-25-win10-uwp-win2d-入门-看这一篇就够了"
author: lindexi
...
Win2d 是一个很简单的库，这个库使用的底层图形 Windows Runtime 的 API 通过这个库实现的效果可以充分利用硬件加速，用 GPU 强大的计算能力做出华丽界面。通过 Win2d 可以使用 C# 或 C++ 写应用商店应用，包括 UWP 或 windows 8.1 应用，可以在手机或电脑运行，但是现在不支持 WPF 和 WinForms 开发。在底---
title: "win10 uwp win2d 入门 看这一篇就够了"
author: lindexi
date: 2019-5-25 20:0:52 +0800
CreateTime: 2018-2-13 17:23:3 +0800
