---
title: "2019-7-29-Roslyn-使用-Target-替换占位符方式生成-nuget-打包"
author: lindexi
date: 2019-9-2 12:9:31 +0800
CreateTime: 2019-9-2 12:9:31 +0800
categories: Roslyn MSBuild 编译器 nuget 打包 Roslyn MSBuild 编译器 nuget 打包
---
...
先来创建一个 nuspec 文件，把这个文件随意一个文件名`ReresouJesou.nuspec`，如果在 Vis---
title: "Roslyn 使用 Target 替换占位符方式生成 nuget 打包"
author: lindexi
date: 2019-7-29 10:1:18 +0800
CreateTime: 2018-7-24 20:34:29 +0800
