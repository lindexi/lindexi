---
title: "2018-8-10-C#-配置文件存储-各种序列化算法性能比较"
author: lindexi
...
CreateTime: 2018-6-15 12:16:10 +0800
categories: C#
...
原来我的软件在启动的时候是需要读取很多个文件，因为每个模块的配置都不同，所有模块的配置都是模块自己查找配置文件读取，然而大家都知道，在机械硬盘，随机读取文件的性能很差。现在虽然很多用户都是使用固态硬盘，但是对于启动性能优化，还是要尽量减少在软件启动�---
title: "C# 配置文件存储 各种序列化算法性能比较"
author: lindexi
date: 2018-8-10 19:16:52 +0800
CreateTime: 2018-6-15 12:16:10 +0800
