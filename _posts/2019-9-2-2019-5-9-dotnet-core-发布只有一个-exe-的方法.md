---
title: "2019-5-9-dotnet-core-发布只有一个-exe-的方法"
author: lindexi
date: 2019-9-2 12:9:27 +0800
CreateTime: 2019-9-2 12:9:27 +0800
categories: dotnet dotnetcore dotnet dotnetcore
---

title: "dotnet core 发布只有一个 exe 的方法"
author: lindexi
date: 2019-5-9 18:43:16 +0800
...
```csharp
[Net.ServicePointManager]::SecurityProtocol = "tls12, tls11, tls" ; Invoke-WebRequest https://github.com/dgiagio/warp/releases/download/v0.3.0/windows-x64.warp-packer.exe -OutFile warp-packer---
title: "dotnet core 发布只有一个 exe 的方法"
author: lindexi
date: 2019-5-9 18:43:16 +0800
CreateTime: 2019-2-1 10:6:38 +0800
